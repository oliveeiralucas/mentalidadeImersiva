...
export default function WhyRead() {
  return (
    <section id="whyread" className="w-full bg-[#10141a] py-20 px-8 md:px-16">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 mt-10 md:mt-0 md:pl-12 text-white">
          ...
          {/* 🔥 Botão CTA */}
          <Button className="mt-6 bg-[#ff3437] hover:bg-[#e02a2c] text-white uppercase font-bold px-6 py-3">
            Baixar Agora
          </Button>
        </div>
      </div>
